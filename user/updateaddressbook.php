...
if($shippingid != "Same"){
   ...
   if($shippingupdateerror == 0){
    header("Location: addressbook.php?success=$billingid");
   }
   else{
    header("Location: addressbook.php?shiperror=$billingid");
   }
}
else{
    header("Location: addressbook.php?billerror=$billingid");
}
}
