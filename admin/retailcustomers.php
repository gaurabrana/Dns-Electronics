            ...
            <div class="content-body">
                ...
                <div class="row page-titles mx-0">
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Retail Customers</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                        <div class="card-body">
                        <input hidden id="customertype" value="retail">
                                <h4 class="card-title">Retail Customers</h4>
                                <div class="table-responsive">
                                    <table class="table table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php
                                            $getAllCustomers = "Select * from customer where type = 'retail'";
